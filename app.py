...
def event_handle(event,json_line):
    ...
    if msgType == "text":
        ...
        if msg == "คณิตศาสตร์พื้นฐาน 1 ค31101 ภาคเรียนที่1":
            ...
            replyObj = TextSendMessage(text="ปริมาณสารสัมพันธ์ ว31222 ภาคเรียนที่ 2• บทที่4 โมลและสูตรเคมีก็จะมีการหาค่ามวลอะตอมสัมพัทธ์ มวลอะตอมเฉลี่ย มวลต่อโมล มวลสูตร ร้อยละโดยมวลของธาตุ• บทที่5 สารละลาย การหาค่าร้อยละโดยมวล ร้อยละโดยปริมาตร ร้อยละโดยมวลต่อปริมาตร")
            line_bot_api.reply_message(rtoken, replyObj)                           
        elif msg == "covid":
