...
def event_handle(event,json_line):
    ...
    if msgType == "text":
        ...
        if msg == "คณิตศาสตร์พื้นฐาน 1 ค31101 ภาคเรียนที่ 1":
            ...
            replyObj = TextSendMessage(text="คณิตศาสตร์พื้นฐาน 2 ค31102 ภาคเรียนที่ 2 บทที่ 1 หลักการนับเบื้องต้น- หลักการบวก คือการนับจํานวนสิ่งของ เหตุการณ์ หรือวิธีการทํางานทไี่ ม่สามารถทําพร้อมกันได้ ใช้วิธี n1 + n2- หลักการคูณ คือการนับจํานวนสิ่งของ เหตุการณ์ หรือวิธีการทํางานที่ต้องทําต่อเนื่องกัน ใช้วิธี n1 × n2 - แฟกเทอเรียล เขียนแทนด้วย n! อ่านว่าเอ็นแฟกเทอเรียล โดย n เป็นจํานวนเต็มบวกแต่บางทีก็ใช้ 0!- การเรียงสับเปลี่ยนเชิงเส้นของสิ่งของที่แตกต่างกันทั้งหมดเป็นการนําสิ่งของมาเรียงสับเปลี่ยนในแนวเส้นตรง มี 2 กรณี คือเมื่อมี n สิ่ง ที่แตกต่างกันแล้วนํามาเรียงสับเปลี่ยนทั้ง n สิ่งนั้น และอกี กรณีคือเมื่อมีของ n ชิ้น ที่ แตกต่างกันแล้วนํามาเรียงสับเปลี่ยน r ชิ้น (เรียงไม่ทั้งหมด) ใช้สัญลักษณ์ P (n, r)-การจัดหมู่ของสิ่งของที่แตกต่างกนัทั้งหมดคือจํานวนวิธีเลือกสุ่มสิ่งของมาโดยไมพ่ิจารณาลําดับก่อนหลังใช้ สัญลักษณ์คือ C(n, r)บทที่ 2 ความน่าจะเป็น (Probability)- ความน่าจะเป็น คือการศึกษาเกี่ยวกับโอกาสที่จะเกิดขึ้นของเหตุการณ์ต่างๆ- การทดลองสุ่ม คือการทดลองซึ่งทราบว่าผลลัพธ์ว่าจะเป็นอะไรได้บ้าง แต่ไม่สามารถบอกได้อย่างถูกต้องว่า ในแต่ละครั้งผลที่เกิดขึ้นจะเป็นอย่างไร- ปริภูมิตัวอย่างหรือแซมเปิลสเปซ คือเซตทมี่ ีสมาชิกเป็นผลลัพธ์ที่อาจเป็นไปได้ทั้งหมดของการสุ่ม แทนด้วย S ส่วนจํานวนสมาชิกแซมเปิลสเปซแทนด้วย n(S)- เหตุการณ์ คือสับเซตของแซมเปิลสเปซ แทนด้วย E ส่วนจํานวนสมาชิกเหตุการณ์แทนด้วย n€- ความน่าจะเป็นของเหตุการณ์ คืออัตราส่วนระหว่างจํานวนสมาชิกเหตุการณ์ที่สนใจกับจํานวนสมาชิกแซม เปิลสเปซที่มีโอกาสเกิดขึ้นเท่า ๆ กัน แทนด้วย P€บทที่ 3 ความสัมพันธ์และฟังก์ชัน- ผลคูณคาร์ทีเซียนของเซต A และ B คือเซตของคู่อันดับที่สมาชิกตัวหน้ามาจากเซต A และตัวหลังมาจากเซต B- โดเมนและเรนจ์ของความสัมพันธ์ โดยโดเมนของ r คือเซตทมี่ ีสมาชิกตัวหน้าของทุกคู่อันดับใน r แทนด้วย Dr ส่วนเรนจ์ของ r คือเซตที่มีสมาชิกตัวหลังของทุกคู่อันดับใน r แทนด้วย Rr-ฟังก์ชันคือความสัมพันธ์ซงึ่สมาชิกในโดเมนแต่ละตัวจับคู่กับสมาชิกในเรนจ์ของความสัมพันธ์ตัวเดียวเท่านั้น แทนด้วย f- ฟังก์ชันผกผัน คือความสัมพันธ์ที่เกิดจากการสลับที่ของสมาชิกตัวหน้าและตัวหลัง - การดําเนินการของฟังก์ชันมี 4 แบบ คือผลบวก, ผลต่าง, ผลคูณ และผลหาร- ฟังก์ชันประกอบเป็นฟังก์ชันทมี่ ีโดเมนและเรนจ์เป็นสับเซตของจํานวนจริง")
            line_bot_api.reply_message(rtoken, replyObj)
            ...
            replyObj = TextSendMessage(text="ความรู้พื้นฐานสําหรับแคลคูลัส 2 ค31202 ภาคเรียนที่ 2 บทที่ 1 ภาคตัดกรวย- ภาคตัดกรวย คือรูปในระนาบที่เกิดจากการตัดกันของระนาบกับกรวย มี 4 รูปแบบ คือเมื่อระนาบตั้งฉากกับ แกนของกรวย ระนาบตัดกรวยข้างเดียว เรียกว่าวงกลม, เมื่อระนาบไม่ตั้งฉากกับแกนของกรวยแต่ทํามุมแหลม กับแกนของกรวย ระนาบตัดกรวยข้างเดียว เรียกว่าวงรี, เมื่อระนาบขนานกับตัวก่อกําเนิดกรวย ระนาบตัด กรวยข้างเดียว เรียกว่าพาราโบลา และเมื่อระนาบขนานกับแกนของกราย ระนาบตัดกรวยสองข้าง เรียกว่า ไฮเพอร์โบลา- ภาคตัดกรวยวงกลม คือเซตของจุดทั้งหมดในระนาบที่ห่างจากจุด ๆ หนึ่งที่ตรงึ อยู่กับที่เป็นระยะทางคงตัว จุดที่ตรึงอยู่กับที่คือจุดศูนย์กลาง ส่วนระยะทางคงตัวคือรัศมี (r) สมการวงกลมมีจุดศูนย์กลางอยู่ที่ (h, k) ซึ่ง สูตรคือ (x - h)2 + (y - k)2 = r2- ภาคตัดกรวยวงรี คือเซตของจุดทั้งหมดในระนาบ ซึ่งผลบวกของระยะทางจากจุด ๆ ใดไปจุด F1 และ F2 ที่ ตรึงอยู่กับที่ โดยค่าคงตัวมีค่ามากกว่าระยะห่างของจุดที่ตรงึ อยู่ ส่วนประกอบมีจุดโฟกัส (F, F'), จุดศูนย์กลาง, จุดยอด (V, V'), แกนวงรีหรือแกนสมมาตร, แกนเอก, แกนโท และเลตัสเรคตัม- ภาคตัดกรวยพาราโบลา คือเซตของจุดทั้งหมดบนระนาบ ซึ่งห่างจากจุด F ที่ตรึงกับที่และเส้นตรงที่ตรึงกับที่ เป็นระยะทางเท่ากนั ส่วนประกอบมีจุดโฟกัส,เส้นไดเรคตริกส,์แกนพาราโบลาหรือแกนสมมาตร,จุดยอด และเลตัสเรคตัม สมการแนวนอนคือ y2 = 4cx แนวตั้งคือ x2 = 4cy- ภาคตัดกรวยไฮเพอร์โบลา คือเซตของจุดทั้งหมดบนระนาบ ซึ่งผลต่างของระยะทางจากจุดใด ๆ ไปจุด F1 และ F2 ที่ตรึงกับที่มีค่าคงตัว โดยค่าคงตัวมีค่าน้อยกว่าระยะห่างของจุดที่ตรึงอยู่ ส่วนประกอบมีจุดโฟกัส, จุด ศูนย์กลาง, แกนไฮเพอร์โบลาหรือแกนสมมาตร, แกนตามขวาง, แกนสังยุค, เลตัสเรคตัม และเส้นกํากับบทที่ 2 เมทริกซ์ (Matrix)- เมทริกซ์ คือกลุ่มของจํานวนที่เรียงเป็นรูปสี่เหลี่ยมมุมฉาก โดยแต่ละแถวมีจํานวนเท่า ๆ กัน อยู่ใน เครื่องหมาย [ ] ซงึ่ จํานวนใน [ ] เรียกว่าสมาชิกของเมทริกซ์- มิติ คือ แถว × หลัก ซึ่งแถวคือแนวนอน ส่วนหลักคือแนวตั้ง- ชนิดของเมทริกซ์ มี 5 ชนิด คือจัตุรัส (แถว = หลัก), ศูนย์ (สมาชิกเมทริกซ์เป็น 0 ทุกตัว), เอกลักษณ์ (เป็น เมทริกซ์จัตุรัสและมี 1 เป็นสมาชิกแนวทแยงขวา), แถว (มี 1 แถว), หลัก (มี 1 หลัก)- การบวกลบเมทริกซ์ จะสามารถบวกลบกันได้ก็ต่อเมื่อมมี ิติเทา่ กัน ตําแหน่งเดียวกัน - การคูณเมทริกซ์ด้วยจํานวนจริง คือเอาจํานวนจริงคูณสมาชิกทุกตัวในเมทริกซ์- การคูณเมทริกซ์ด้วยเมทริกซ์ จะสามารถคูณกันได้ก็ต่อเมื่อหลักของตัวหน้า = แถวของตัวหลัง จะได้คําตอบ เป็นแถวของตัวหน้า × หลักของตัวหลัง- การแก้ระบบสมการเชิงเส้นโดยใช้เมทริกซ์ มี 3 วิธี คืออินเวอร์สการคูณของเมทรกิ ซ์, กฎของคราเมอร์ และการดําเนินการตามแถว (~)")
            line_bot_api.reply_message(rtoken, replyObj)
        elif msg == "ภาษาไทย 1 ท31101 ภาคเรียนที่ 1":
            replyObj = TextSendMessage(text="ภาษาไทย 1 ท31101 ภาคเรียนที่ 1• บทที่ 1 คํานมัสการคุณานุคุณแบ่งออกเป็น 5 ตอน เป็นการพรรณนาคุณงามความดีที่พระพทุ ธ พระธรรม พระสงฆ์ บิดามารดา และครู อาจารย์มีต่อชนทุกชั้น เนื้อหาส่วนใหญ่จะเกี่ยวเนื่องในทางพุทธศาสนา มีเนื้อหาที่ละเอียดลึกซึ้ง แต่งด้วย อินทรวิเชียรฉันท์ 11 และกาพย์ฉบัง 16• บทที่ 2 อิเหนา ตอน ศึกกะหมังกุหนิงเป็นวรรณคดีบทละครรําที่มมี าตั้งแต่สมัยกรุงศรีอยุธยา มีทมี่ าจากนิทานปันหยีที่ถูก แต่งเป็นกลอนบทละครที่ มีลักษณะบังคับเหมือนกลอนสุภาพ โดยรัชกาลที่ 2 ได้ทรงดัดแปลงแก้ไขให้เข้ากับธรรมเนียมและรสนิยมของ คนไทย• บทที่ 3 นิทานเวตาล (เรื่องที่ 10)เป็นวรรณกรรมสันสกฤตโบราณ ที่แทรกสุภาษิตและคติธรรมไว้และจะได้ศึกษาเรื่องความเป็นอยู่ ความเชื่อประเพณี พิธีกรรม และวัฒนธรรมอินเดียโบราณ ที่แต่งโดยร้อยแก้ว • บทที่ 4 นิราศนรนิ ทร์คําโคลงเนื้อหาเป็นการคร่ําครวญและพรรณนาความรู้สึกอาลัยอาวรณ์ที่มีต่อนางอนัเป็นที่รักด้วยสํานวนโวหารแต่งด้วยคําประพันธ์ประเภทร่ายสุภาพ 1 บท และโคลงสี่สุภาพ 143 บท")
            line_bot_api.reply_message(rtoken, replyObj)
            ...
            replyObj = TextSendMessage(text="ภาษาอังกฤษพื้นฐาน 1 อ31101 ภาคเรียนที่ 1- Present Simple Tenseประโยคที่มีโครงสร้างแบบง่าย ๆ เพื่อใช้พูดถึงเหตุการณ์ในปัจจุบัน โดยมีลักษณะต่าง ๆ ดังนี้บอกเล่า: Subject + Verb.1(s,es)ปฏิเสธ: แบบที่ 1 : Subject + Verb to be + not + Verb.1แบบที่ 2 : Subject + Verb to do + not + Verb.1 คําถาม: แบบที่ 1 : Verb to be + Subject + Verb.1?แบบที่ 2 : Verb to do + Subject + Verb.1? - Unit1: Life in Cityพูดถึงความโดดเด่นของอัสตานาศูนย์กลางแห่งใหม่ของคาซัคสถาน และยังเป็นเมืองที่สร้างยุคใหม่ของเมืองมี ตึกระฟ้าทนี่่าตื่นเต้นและสะดุดตายังมีการสร้างสิ่งแปลกตาคือหอคอยแบร์เตียเรียกที่เป็นสัญลักษณ์ของเมือง มีความสูงที่ 345 ฟุต ดูใหญ่มหึมาเหมือนต้นไมท้ ี่มีไขท่ องคําอยขู่ ้างใน อัสตานามีหน้าร้อนที่น่าพอใจ แต่อากาศ ก็ค่อนข้างที่จะหนาว ชาวเมืองจึงเลือกที่จะทํากิจกรรมในรม่ กนั ส่วนใหญ่ สถานที่ที่เป็นชื่อเสียงก็คือ Khan Shatyr หรือเต็นท์ที่สูงที่สุดในคาซัคสถาน- Present Continuous Tenseบอกถึงเหตุการณ์ที่กําลังเกิดขึ้น ณ ขณะทพี่ ูด หรือเป็นเหตุการณ์ที่กําลังจะเกิดขึ้นในอนาคตอันใกล้(ซึ่งมีการ วางแผน)บอกเล่า: Subject + V. to be + V.ing ปฏิเสธ: Subject + V. to be + not + V.ing คําถาม: V. to be + Subject + V.ing?- Preposition of place & TimeIn: เดือน/ปี, ช่วงของวัน, สถานที่หรือสิ่งทั่วไปที่มีขอบเขตชัดเจน,ยานพาหนะประเภทรถยนต์ทั่วไปOn: วันที่/วัน, วันหยุด/วันเทศกาล (แบบมีคําว่าday), ระบุตําแหน่งสิ่งที่อยู่บนพื้นผิวของสิ่งอื่น, บนถนนหรือ พื้นที่ตามแนวถนน, ชั้นของอาคาร, ยานพาหนะประเภทขนส่งมวลชน จักรยาน และมอเตอร์ไซค์At: บอกเวลากี่โมง/กี่นาที, เที่ยงคืน/เที่ยงวัน, วันหยุด/วันเทศกาล (แบบไม่มีคําว่าday), จุดตําแหน่งเฉพาะ, สถานที่ทั่วไป, ใช้บอกสถานที่ทํางาน หรือโรงเรียน,ใช้บอกที่อยู่- Modal Verbsใช้แสดงความเป็นไปได้และแนวโน้มของความเป็นไปได้ แสดงได้ทั้งความเป็นปัจจุบัน และความเป็นอนาคตแบ่งได้ 3 ระดับ1) เป็นไปได้มาก(ในปัจจุบันหรือในอนาคต): can,will,must2) เป็นไปได้ปานกลาง(ในปัจจุบันหรือในอนาคต): may,might,could,should4) 3)เป็นไปได้น้อย(ในปัจจุบันหรือในอนาคต): could")
            line_bot_api.reply_message(rtoken, replyObj)
