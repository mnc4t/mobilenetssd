...
def event_handle(event,json_line):
    ...
    if msgType == "text":
        ...
        if msg == "คณิตศาสตร์พื้นฐาน 1 ค31101 ภาคเรียนที่1":
            ...
            replyObj = TextSendMessage(text="Genetic ว31242 ภาคเรียนที่ 2 บทที่ 3 เซลล์และการทํางานของเซลล์- โครงสร้างและหน้าที่ของเซลล์ เซลล์มี2ประเภทคือโพรแคริโอตและยูแคริโอต เยื่อหุ้มเซลล์พบในเซลล์ทุก ชนิด ผนังเซลล์พบในเซลล์พืชไม่พบในเซลล์สัตว์ สารเคลือบเซลล์พบในเซลล์ทุกชนิด ไซโทพลาซึม ประกอบด้วยออร์แกแนลล์และไซโทซอล นิวเคลียสเป็นศูนย์กลางควบคุมการทํางานของเซลล์- การแบ่งเซลล์ มี2ขั้นตอน คือ แบ่งนิวเคลียส(ไมโทซิส/ไมโอซสิ ) และแบ่งไซโทพลาสซึม(ในเซลล์พืชจะสร้าง แผ่นกั้นเซลล์ เซลล์สัตว์เยื่อหุ้มเซลล์จะคอดเข้าหากันจนแยกออกจากกัน)บทที่ 4 โครโมโซมและสารพันธุกรรม- โครโมโซม คือโครมาทินที่มีการขดตัวทําให้หนาขึ้นและสั้นลง- สารพันธุกรรม เรียกอีกอย่างว่าDNA- สมบัติของสารพันธุกรรม(การจําลองDNA/การสังเคราะห์DNA,การจําลองแบบกึ่งอนุรักษ์,การถอดรหัส,การ แปลรหัส,รหัสพันธุกรรม)- มิวเทชัน(ระดับยีน,ระดับโครโมโซม)บทที่ 5 การถ่ายทอดลักษณะทางพันธุกรรม- การศึกษาพันธุกรรมของเมนเดล(กฎการแยก,กฎการรวมกลมุ่ อย่างอิสระ,การถ่ายทอดยีนบนโครโมโซม) การ ประยุกต์ใช้กฎของเมนเดล(การผสมทดสอบ,การผสมกลับ)-ลักษณะทางพนัธุกรรมที่เป็นส่วนขยายของพันธุศาสตร์เมนเดล(ความเด่นไม่สมบูรณ์,ความเด่นร่วม,มัลติเพิล แอลลีล,ลักษณะควบคุมด้วยยีนหลายคู่,การแปรผันต่อเนื่อง/ไม่ต่อเนื่อง,การถ่ายทอดยีนบนโครโมโซมเพศ)- ยีนบนโครโมโซมเดียวกัน อยู่ใกล้กันมากจะถ่ายทอดไปพร้อมๆกัน เรียกว่า ลิงเกจ การจัดกลุ่มใหม่ของยีน ต่างตําแหน่งที่ทําให้ได้กลุ่มยีนที่ต่างไปจากพ่อหรือแม่ เรียกว่า รีคอมบิเนชันบทที่ 6 เทคโนโลยีทางดีเอ็นเอ- พันธุวิศวกรรมและการโคลนยีน การเพิ่มจํานวนดีเอ็นเอทําได้2วิธี คือ 1.ใช้พลาสมิดของแบคทีเรีย - ใช้ดีเอ็น เอพาหะหรือเวกเตอร์ 2.ทําในหลอดทดลอง(เทคนิคPCR) - ต้องมี ไพรเมอร์ ดีเอ็นเอแม่แบบ นิวคลีโอไทด์ทั้ง4 ชนิด การสร้างดีเอ็นเอรีคอมบิแนนท์-ใช้เอ็นไซม์ตัดจําเพาะตัดสายดีเอ็นเอ และใช้เอนไซม์ดีเอ็นเอไลเกสเชื่อม สายดีเอ็นเอ- การหาขนาดของ DNA และการหาลําดับนิวคลีโอไทด์ – DNA(ใช้เทคนิคเจลอิเล็กโทรฟอรีซิส) นิวคลีโอไทด์ (ใช้เครื่องหาลําดับนิวคลีโอไทด์แบบอัตโนมัติ)- การประยุกต์ใช้เทคโนโลยีทางดีเอ็นเอ(ด้านการแพทย์และเภสัชกรรม,ด้านการเกษตรและอุตสาหกรรม,ด้าน นิติวิทยาศาสตร์)- เทคโนโลยีทางดีเอ็นเอกับความปลอดภัยทางชีวภาพและชีวจริยธรรม(ชีวิตและสุขภาพ,ป้องกันการสูญเสียความหลากหลายทางชีวภาพ,ปฏิบัติต่อสิ่งมีชีวิตอย่างมีคุณธรรม,มุมมองทางสังคมในด้านอื่นๆ)")
            line_bot_api.reply_message(rtoken, replyObj)
        elif msg == "ธาตุ พันธะเคมีและเทคนิคปฏิบัติการ ว31221 ภาคเรียนที่ 1":
            replyObj = TextSendMessage(text="ธาตุ พันธะเคมีและเทคนิคปฏิบัติการ ว31221 ภาคเรียนที่ 1• บทที่1 ความปลอดภัยและทักษะในการปฏิบัติการเคมี ประเภทของสารเคมีต่างๆ การปฏิบัติตนและการวัด ปริมาณสาร หน่วยวัด• บทที่2 แบบจําลองอะตอมต่างๆ การจัดเรียงอิเล็กตรอน ตารางธาตุและสมบัติของธาตุในหมู่หลัก ธาตุแทรน ซิชัน8หมู่ การนํารังสีต่างๆไปใช้ประโยชน์ในชีวิตประจําวัน• บทที่3 พันธะเคมี สัญลักษณ์แบบจุดของลิวอิสและออกเตต การเกิดพันธะไอออนิกคณุ สมบัติของ สารประกอบไอออนกิ เป็นผลึกแข็ง พันธะโคเวเลนต์13) ปริมาณสารสัมพันธ์ ว31222 ภาคเรียนที่ 2 บอทตอบกลับว่า :ปริมาณสารสัมพันธ์ ว31222 ภาคเรียนที่ 2• บทที่4 โมลและสูตรเคมีก็จะมีการหาค่ามวลอะตอมสัมพัทธ์ มวลอะตอมเฉลี่ย มวลต่อโมล มวลสูตร ร้อยละโดยมวลของธาตุ• บทที่5 สารละลาย การหาค่าร้อยละโดยมวล ร้อยละโดยปริมาตร ร้อยละโดยมวลต่อปริมาตร")
            line_bot_api.reply_message(rtoken, replyObj)
        elif msg == "ฟิสิกส์กายภาพ ว30111 ภาคเรียนที่ 1":
            replyObj = TextSendMessage(text="ฟิสิกส์กายภาพ ว30111 ภาคเรียนที่ 1  1. บทนํา เนื้อหาที่จะเจอจะเป็นการค้นหาความจริงในทางธรรมชาติโดยหาเหตุผล กฎเกณฑ์ มาอธิบายถึงสิ่ง ที่ธรรมชาติสร้างขึ้น หรือสิ่งที่เกิดขึ้นเองตามวิถีทางธรรมชาติ ซึ่งจะเห็นได้ว่าฟิสิกส์เป็นเรื่องที่สามารถพบ เห็นได้เพราะฟิสิกส์คือความจริงที่สามารถพิสูจน์ได้ บทนี้ก็จะเรียนเกี่ยวกับ การเคลื่อนที่ แรง มวลปริมาณกายภาพและหน่วย การอ่านผลจากเครื่องมือวัด เลขนัยสําคัญ เป็นต้น")
            line_bot_api.reply_message(rtoken, replyObj)
